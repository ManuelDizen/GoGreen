        ...
        <div class="container">
            ...
            <div class="col s9">
                <div class="row" style="height:50%;">
                    <h3><spring:message code="sellerpage.news.title"/></h3>
                    <c:forEach items="recentNews" var="article">
                        <div>
                            <div class="row" style="text-align: right;">
                                <%--<c:out value="${article.datetime}"/>--%>
                            </div>
                        ...
                        <div>
                            ...
                            <div>
                                <div class="center-in-div-with-flex">
                                    ...
                                    <a class="productpage-link" href="<c:url value="/explore?category=${product.category.id}&sort=${sort}&direction=${direction}"/>">
                                        <spring:message code="${product.category.name}"/>
                                    </a>
                                </div>
                                <c:if test="${product.areaId != null}">
                                    <div class="center-in-div-with-flex">
                                        <i class="tiny material-icons separate-icon">location_pin</i>
                                        <span>
                                            <c:forEach items="areas" var="area">
                                                <c:if test="${area.id == product.areaId}">
