...
<form action="${explore}" method="get" id="filter_form" class="filter-form">
    <sec:authorize access="hasRole('USER')">
        <div class="row" style="margin: 0; display:flex; justify-content:space-between;">
            ...
            <c:if test="${favorite}">
                <div class="eco_input flex-column-center-align-vertical"
                     style="padding:0; text-align:left;
                width:58%; font-size:20px;">
                    <label style="margin: 0 10px; font-size: 15px;" for="favorite2">
                        <spring:message code="explore.filterform.favorite"/>
                    </label>
                </div>
                <div style="text-align: center;">
                    <input class="star star-table-cell" name="favorite" type="checkbox"
                           checked="checked" id="favorite2">
                </div>
            </c:if>
        </div>
    </sec:authorize>
