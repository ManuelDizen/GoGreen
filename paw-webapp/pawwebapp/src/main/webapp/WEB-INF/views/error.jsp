...
<div class="error-container error-height">
    <div class="error-container-block">
        ...
        <h4><spring:message code="error.code" arguments="${error}"/></h4>
        <div class="circle">
        ...
        <div class="error-margin">
            <div>
                <a class="decision-button waves-effect waves-light btn"
                   href="<c:url value="/"/>"><spring:message code="error.goback"/></a>
            </div>
        </div>
    </div>
</div>
